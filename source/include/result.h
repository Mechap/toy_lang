    ...
    struct Result<void, E> {
      ...
      public:
        ...
        Result(Result&& other) {
            ...
            if (this->state == STATE_ERR) this->err = static_cast<E&&>(other.err);
        }
        ...
        static Result of_value() { return Result<void, E>(); }
